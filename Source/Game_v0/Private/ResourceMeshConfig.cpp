...
void UResourceMeshManager::InitializeDefaultConfigs()
{
    ...
    BowConfig.Meshes.Add(TSoftObjectPtr<UStaticMesh>(
        FSoftObjectPath(TEXT("/Game/Resources/WeaponMeshes/ElfBow_Mesh.ElfBow_Mesh"))
    ));
    BowConfig.Meshes.Add(TSoftObjectPtr<UStaticMesh>(
    ...
    WaterConfig.Meshes.Add(TSoftObjectPtr<UStaticMesh>(
        FSoftObjectPath(TEXT("/Game/Resources/WaterBucketEmpty_Mesh.WaterBucketEmpty_Mesh"))
    ));
